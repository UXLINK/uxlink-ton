...
import { UxlinkJetton, storeMint, Mint, TokenUpdateContent } from "../output/UxlinkJetton_UxlinkJetton";
...
(async () => {
    ...
    let contentUpdate = buildOnchainMetadata(tokenParamsUpdate);
    const ContentUpdate: TokenUpdateContent = {
        $$type: "TokenUpdateContent",
        content: contentUpdate,
    };
    await contract_open.send(walletSender, { value: toNano(0.1) }, ContentUpdate);
