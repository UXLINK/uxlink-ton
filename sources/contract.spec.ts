...
// -------- Contract SDK --------
import { UxlinkJetton, Mint, TokenTransfer } from "./output/UxlinkJetton_UxlinkJetton";
import { JettonDefaultWallet, TokenBurn } from "./output/UxlinkJetton_JettonDefaultWallet";
...
describe("contract", () => {
    ...
    let token: SandboxContract<UxlinkJetton>;
    ...
    beforeAll(async () => {
        ...
        token = blockchain.openContract(await UxlinkJetton.fromInit(deployer.address, content, max_supply));
    ...
    it("Onchian Testing: DeDust", async () => {
        ...
        const jettonRoot = blkch.openContract(await UxlinkJetton.fromInit(player.address, content, max_supply));
